...
contract ARC_Staking is Ownable,Pausable{
    ...
    uint256 public minimumDeposit = 100000000000000000000000; //100000 arc
...
//  receive the arc
    ...
    function farm(uint256 _lockableDays) public payable whenNotPaused
    {
    ...
    function harvest(uint256 [] memory _index) external whenNotPaused
    {
